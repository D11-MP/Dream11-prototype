           ...
           {/* middle portion */}
            <div className="flex justify-between items-center" style={{width:`calc(100 - 40/window.innerWidth)vw`,margin:'10px 20px'}}>
                <div className="match-details flex justify-between items-center">
                    <div className="match-logo flex flex-col justify-between items-center"><Image width={50} height={50} src={match.homeTeamLogo.src} alt=''/><p className="match-logo-name" style={{color:'gray'}}>{match.homeTeam}</p></div>
                    <div className="match-name" style={{marginTop:'-8px'}}>{(match.homeTeam).slice(0,3)}</div>
                    <div style={{marginTop:'-8px'}}><Image width={20} height={20} src={vs.src} alt=''/></div>
                    <div className="match-name" style={{marginTop:'-8px'}}>{(match.awayTeam).slice(0,3)}</div>
                    <div className="match-logo flex flex-col justify-between items-center"><Image width={50} height={50} src={match.awayTeamLogo.src} alt=''/><p className="match-logo-name" style={{color:'gray'}}>{match.awayTeam}</p></div>
                </div>
            ...
            <div className="flex justify-between items-center" style={{width:`calc(100 - 40/window.innerWidth)vw`,margin:'0px 20px'}}>
                <div className="top-player-box flex items-center gap-4"><Image width={20} height={20} src={star.src} alt=''/>{match.homePlayer} , {match.awayPlayer}</div>
                <div><Image width={25} height={25} src={bell.src} alt=""/></div>
            </div>
