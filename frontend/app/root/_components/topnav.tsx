    ...
    <div className="flex items-center justify-between bg-white h-[96px] px-[32px] w-full ">
      ...
      <div className="flex flex-row gap-[60px]">
        ...
        <Link
          href="/root/matches"
          className={`text-gray-700 font-medium ${
            pathName === "/matches" ? "text-red-600" : "text-black"
          }`}
        >
          <div
            className={"flex items-center space-x-2 cursor-pointer p-2 rounded"}
        ...
        <Link
          href="/root/news"
          className={`text-gray-700 font-medium ${
            pathName === "/news" ? "text-red-600" : "text-black"
          }`}
        >
          <div
            className={"flex items-center space-x-2 cursor-pointer p-2 rounded"}
        ...
        <Link
          href="/root/help"
          className={`text-gray-700 font-medium ${
            pathName === "/help" ? "text-red-600" : "text-black"
          }`}
        >
          <div
            className={"flex items-center space-x-2 cursor-pointer p-2 rounded"}
        ...
        <Link
          href="/root/settings"
          className={`text-gray-700 font-medium ${
            pathName === "/settings" ? "text-red-600" : "text-black"
          }`}
        >
          <div
            className={"flex items-center space-x-2 cursor-pointer p-2 rounded"}
      ...
      <div className="flex justify-center items-center">
        ...
        {session.status === "unauthenticated" && (
          <div className="flex items-center">
            <button
              className="flex items-center justify-evenly px-4 py-2 text-white rounded bg-red-500"
              onClick={() => {
                router.replace("/login");
              }}
            >
