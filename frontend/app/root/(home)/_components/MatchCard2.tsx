...
import { MatchCardProps2 } from "@/types";
...
export const MatchCard2: React.FC<MatchCardProps2> = ({ match }) => {
    ...
    <div className="flex flex-col">
      <div className="flex flex-col justify-between w-full bg-white rounded-lg shadow-md p-4 mb-1">
        <div className="flex justify-between items-center my-4">
          ...
          <div className="flex flex-col items-center ">
            <button
              onClick={() => setClicked(1 - clicked)}
              className="flex cursor-pointer text-red-500 bg-red-50 px-3 py-1 rounded-md transition-all duration-300 ease-in-out"
            >
              ...
              {clicked ? (
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="size-6 transition-transform duration-300 ease-in-out transform rotate-180"
                >
                  <path
                    strokeLinecap="round"
                ...
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="size-6 transition-transform duration-300 ease-in-out transform rotate-0"
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
